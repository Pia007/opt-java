public class MathOperations {
    public static void main (String[] args) {
        ...
        // an operation between whole numbers always returns a whole number
        ...
        // += operator (add by) and -= operator (subtract by)
        int passengers = 0;
        passengers += 9;
        passengers -= 5;
        System.out.println("I count: " + passengers + " passengers");
